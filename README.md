...
```
人 ──intent:analyze──▶ analyze-agent (全责交付：写 spec + 业务码 + push feat/REQ-x + 开 PR；自决拆 sub-issue)
                         │
                         ▼
...
│   │   ├── actions/          # stage 推进动作（start_intake / start_analyze / start_challenger / create_spec_lint / create_dev_cross_check / create_staging_test / create_pr_ci_watch / create_accept / teardown_accept_env / done_archive / escalate / ...）
...
│   └── migrations/           # Postgres schema (0001_init 至 0007_add_event_seen_processed_at)
