...
3. **观测指导改进** —— 每个 stage 入 `stage_runs`、每条 verifier 决策入 `verifier_decisions`，18 条 Metabase SQL（Q1–Q18）回答"哪条 prompt 该改 / 哪个 stage 钻牛角尖 / 哪类 fixer 修不动 / 机械 checker 有没有沉默通过"。
...
├── observability/
│   ├── schema.sql
│   ├── queries/sisyphus/     # 18 条 Metabase SQL（Q1–Q18：M7 + M14e + fixer-audit Q14–Q16 + dedup-retry Q17 + silent-pass Q18）
