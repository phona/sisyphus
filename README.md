...
人 ──intent:analyze──▶ analyze-agent (写 proposal/design/tasks)
     ...
     verifier ◀── pr-ci-watch (sisyphus 直调 GitHub REST 轮 check-runs)
        ...
        │   pass ────┘
        │            ▼
        │         accept-agent (sisyphus 先 make accept-up，agent 跑 FEATURE-A*)
        │            │
        │   pass ────┘
        ▼            ▼
       fixer       teardown (make accept-down，必跑)
        │            │
...
| `make accept-up` | sisyphus pre-accept | helm install lab |
| `make accept-down` | teardown_accept_env | accept 完必跑 |
