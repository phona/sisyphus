...
| [analyze.md.j2](../orchestrator/src/orchestrator/prompts/analyze.md.j2) | analyze | `actions/start_analyze.py`（直接入口）/ `actions/start_analyze_with_finalized_intent.py`（intake 后入口） |
