# Tasks: REQ-clone-fallback-direct-execute-1777119520

## Stage: spec

- [x] `openspec/changes/REQ-clone-fallback-direct-execute-1777119520/proposal.md`
- [x] `openspec/changes/REQ-clone-fallback-direct-execute-1777119520/tasks.md`
- [x] `openspec/changes/REQ-clone-fallback-direct-execute-1777119520/specs/multi-layer-involved-repos-fallback/spec.md`
- [x] `openspec/changes/REQ-clone-fallback-direct-execute-1777119520/specs/multi-layer-involved-repos-fallback/contract.spec.yaml`
...
- [x] `orchestrator/src/orchestrator/actions/start_execute.py`：
  ...
  - 模块 docstring 增一段 REQ-clone-fallback-direct-execute-1777119520 说明
...
- [x] `orchestrator/tests/test_actions_start_execute.py`：补 8 个 case
  ...
  - `test_start_execute_passes_repo_tags_and_default_to_clone`
  - `test_start_execute_uses_settings_default_when_no_ctx_no_tags`
  - `test_start_execute_skip_remains_when_all_layers_empty`
...
- [x] `orchestrator/tests/test_contract_clone_fallback_direct_analyze.py`：新增
  ...
  - `test_start_execute_actions_pass_tags_and_default_to_clone`
  - `test_repo_tag_extraction_validates_slug`

## Stage: PR

- [x] git push feat/REQ-clone-fallback-direct-execute-1777119520
- [x] gh pr create
