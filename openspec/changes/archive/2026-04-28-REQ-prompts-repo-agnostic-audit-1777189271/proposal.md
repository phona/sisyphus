...
| 文件 | 行 | 内容 |
|---|---|---|
| `execute.md.j2` | 106 | `phona/repo-a [phona/repo-b ...]` |
| `execute.md.j2` | 120 | `gh repo clone phona/repo-a ./repo-a` |
| `execute.md.j2` | 203 | `> spec home repo: phona/repo-a` |
...
预设前缀。`execute.md.j2:45` 自己的 spec example 用的就是 `UBOX-S1` 不是
