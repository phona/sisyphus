...
- [x] `orchestrator/src/orchestrator/snapshot.py`:
      - extract `_trigger_orphan_intent_execute(main_pool, project_id, issues)`
...
- [x] `orchestrator/tests/test_snapshot.py`:
      ...
      - add `test_orphan_intent_execute_triggers_when_missing_req_state`
      - add `test_orphan_intent_execute_skipped_when_already_in_req_state`
      - add `test_orphan_intent_execute_skipped_when_analyze_tag_present`
      - add `test_orphan_intent_execute_skipped_when_status_done`
