# admin-escalate-kind Specification

## Purpose
TBD - created by archiving change REQ-429. Update Purpose after archive.
## Requirements
...
- **GIVEN** a REQ in EXECUTING state and no request body
...
- **GIVEN** a REQ in EXECUTING state
...
- **GIVEN** a REQ in EXECUTING state with ctx.intent_issue_id="intent-123"
